...
website = 'https://www.computrabajo.com.mx/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajo.csv', index=False)