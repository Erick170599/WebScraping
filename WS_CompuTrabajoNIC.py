...
website = 'https://www.computrabajo.com.ni/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajoNIC.csv', index=False)