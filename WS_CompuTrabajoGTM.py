...
website = 'https://www.gt.computrabajo.com/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajoGTM.csv', index=False)