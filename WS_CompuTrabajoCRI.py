...
website = 'https://www.computrabajo.co.cr/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajoCRI.csv', index=False)