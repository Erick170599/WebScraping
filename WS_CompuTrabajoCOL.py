...
website = 'https://www.computrabajo.com.co/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
# website = 'https://www.computrabajo.com.co/empresas/empresas-de-agricultura-y-pesca-y-ganaderia?p=163'
