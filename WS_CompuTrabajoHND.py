...
website = 'https://www.computrabajo.com.hn/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajoHND.csv', index=False)