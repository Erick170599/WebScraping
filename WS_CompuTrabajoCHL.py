...
website = 'https://www.computrabajo.cl/empresas/empresas-de-agricultura-y-pesca-y-ganaderia'  # Variable para guardar la URL.
...
df.to_csv('WS_CompuTrabajoCHL.csv', index=False)